...
class WebShopTest {
    ...
    @BeforeEach
    void init() {
        webShop.addProduct(new Product("Winchester", 10, LocalDateTime.of(2013, 1, 1, 10, 12)));
        webShop.addProduct(new Product("SSD", 8, LocalDateTime.of(2014, 1, 1, 10, 12)));
        webShop.addProduct(new Product("Earphone", 12, LocalDateTime.of(2016, 1, 1, 10, 12)));
        webShop.addProduct(new Product("Mouse", 1, LocalDateTime.of(2017, 1, 1, 10, 12)));
        webShop.addProduct(new Product("Phone", 5, LocalDateTime.of(2015, 1, 1, 10, 12)));
    }
